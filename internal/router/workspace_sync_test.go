...
func startWorkspaceSyncTestFetcher(t *testing.T, responses []*pb.RepoSyncProgress, publishResponses []*pb.RepoSyncProgress) (string, *workspaceSyncTestFetcherServer, func()) {
	t.Helper()

	serverImpl := &workspaceSyncTestFetcherServer{responses: responses, publishResponses: publishResponses}
...
func TestRefreshWorkspaceCompletesAndStoresJob(t *testing.T) {
	...
	fetcherAddr, _, cleanupFetcher := startWorkspaceSyncTestFetcher(t, responses, nil)
...
func TestPublishWorkspaceUploadsBundleAndStoresPublishJob(t *testing.T) {
	...
	fetcherAddr, fetcherServer, cleanupFetcher := startWorkspaceSyncTestFetcher(t, nil, publishResponses)
	defer cleanupFetcher()
